...
#define STRING_CONFIG_H_AUTHOR "(Azsde - dev.azsde@gmail.com)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.121, 80.121, 399.778, 454.90 }
